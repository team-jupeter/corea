defmodule Corea.SilsTest do
  ...
  describe "sils" do
    ...
    @valid_attrs %{current_hash: "some current_hash"}
    ...
    test "create_sil/1 with valid data creates a sil" do
      ...
      assert sil.current_hash == "some current_hash"
    end
    ...
    test "update_sil/2 with valid data updates the sil" do
      ...
      assert sil.current_hash == "some updated current_hash"
    end

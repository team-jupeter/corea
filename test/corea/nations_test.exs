defmodule Corea.NationsTest do
  use Corea.DataCase
  ...
  describe "nations" do
    ...
    @valid_attrs %{constitution_signature: "some constitution_signature", name: "some name"}
    ...
    test "create_nation/1 with valid data creates a nation" do
      ...
      assert nation.constitution_signature == "some constitution_signature"
    ...
    test "update_nation/2 with valid data updates the nation" do
      ...
      assert nation.constitution_signature == "some updated constitution_signature"

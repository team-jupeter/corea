defmodule CoreaWeb.UserAuthTest do
  use CoreaWeb.ConnCase, async: true

  alias Corea.Accounts
  alias CoreaWeb.UserAuth
  import Corea.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CoreaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CoreaWeb.Endpoint.subscribe(live_socket_id)

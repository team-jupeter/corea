defmodule Corea.Accounts.Team do
  import Ecto.Changeset
  use Ecto.Schema
  alias Corea.Accounts.{MemberEmbed, ProjectEmbed}
  ...
  schema "teams" do
    ...
    # has_many :users, Corea.Accounts.User
    belongs_to :entity, Corea.Entities.Entity

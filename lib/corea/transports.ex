defmodule Corea.Transports do
  ...
  @doc """
  Returns the list of transports.
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %Transport{}}

  """
  def change_transport(%Transport{} = transport, attrs \\ %{}) do
    Transport.changeset(transport, attrs)
  end
end

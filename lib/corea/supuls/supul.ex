defmodule Corea.Supuls.Supul do
  use Ecto.Schema
  ...
  schema "supuls" do
    ...
    has_many :payloads, Corea.Mulets.Payload, on_replace: :nilify
    has_many :schools, Corea.Schools.School, on_replace: :nilify
    has_many :openhashes, Corea.Openhashes.Openhash, on_replace: :nilify
    has_many :families, Corea.Families.Family, on_replace: :nilify

    has_one :gab, Corea.Gabs.Gab
    ...
    # has_one :mulet, Corea.Mulets.Mulet
    has_one :gopang, Corea.Gopangs.Gopang

defmodule Corea.GabAccounts.GabAccount do
  use Ecto.Schema
  ...
  schema "gab_accounts" do
    ...
    embeds_many :open_t1s, Corea.ABC.OpenT1, on_replace: :delete
    embeds_many :open_t2s, Corea.ABC.OpenT2, on_replace: :delete
    embeds_many :open_t3s, Corea.ABC.OpenT3, on_replace: :delete
    embeds_many :open_t4s, Corea.ABC.OpenT4, on_replace: :delete

    has_one :t2, Corea.T2s.T2, on_replace: :delete
    has_one :t3, Corea.T3s.T3, on_replace: :delete
    has_one :t4, Corea.T4s.T4, on_replace: :delete

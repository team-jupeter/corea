defmodule Corea.Families.Family do
  use Ecto.Schema
  ...
  schema "families" do
    ...
    has_one :wedding, Corea.Weddings.Wedding, on_replace: :nilify

    belongs_to :nation, Corea.Nations.Nation, type: :binary_id, on_replace: :nilify
    belongs_to :supul, Corea.Supuls.Supul, type: :binary_id, on_replace: :nilify

    has_one :account_book, Corea.AccountBooks.AccountBook, on_replace: :nilify

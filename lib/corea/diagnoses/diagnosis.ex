defmodule Corea.CDC.Diagnosis do
  use Ecto.Schema
  ...
  schema "diagnoses" do
      ...
      has_many :metabolic_panels, Corea.CDC.MetabolicPanel
      embeds_many :medical_images, Corea.CDC.MedicalImageEmbed

      belongs_to :health_report, Corea.CDC.HealthReport, type: :binary_id
      timestamps()
  end

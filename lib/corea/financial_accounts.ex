defmodule Corea.FinancialAccounts do
  @moduledoc """
  ...
  """
  def change_financial_account(%FinancialAccount{} = financial_account, attrs \\ %{}) do
    FinancialAccount.changeset(financial_account, attrs)
  end
end

defmodule Corea.T4s.T4 do
  ...
  schema "t4s" do
    ...
    belongs_to :gab_account, Corea.GabAccounts.GabAccount, type: :binary_id
    belongs_to :gab, Corea.Gabs.Gab, type: :binary_id
    belongs_to :entity, Corea.Entities.Entity, type: :binary_id
    # belongs_to :balance_sheet, Corea.BalanceSheets.BalanceSheet, type: :binary_id

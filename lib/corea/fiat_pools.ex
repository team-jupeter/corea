defmodule Corea.FiatPools do
  ...
  Raises `Ecto.NoResultsError` if the Fiat pool does not exist.
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %FiatPool{}}

  """
  def change_fiat_pool(%FiatPool{} = fiat_pool, attrs \\ %{}) do
    FiatPool.changeset(fiat_pool, attrs)
  end
end

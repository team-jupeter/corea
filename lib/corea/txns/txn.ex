defmodule Corea.Txns.Txn do
  ...
  schema "txns" do
    ...
    belongs_to :invoice, Corea.Invoices.Invoice, type: :binary_id
    has_one :openhash, Corea.Openhashes.Openhash
    has_many :tickets, Corea.Gopang.Ticket, on_delete: :delete_all

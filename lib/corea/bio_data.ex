defmodule Corea.BioData do
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %BioDatum{}}

  """
  def change_bio_datum(%BioDatum{} = bio_datum, attrs \\ %{}) do
    BioDatum.changeset(bio_datum, attrs)
  end
end
